...
export class DirectoryTreeUIModals extends DirectoryTreeUIElements {
    ...
    protected createFileModal(): void {
        ...
        DirectoryTreeUIModals.createFileModalInnerWindowTextContainer.setAttribute(
            "id",
            "create-file-modal-inner-window-text-container"
        );
        DirectoryTreeUIModals.createModalInnerWindow.appendChild(
            DirectoryTreeUIModals.createFileModalInnerWindowTextContainer
        );
