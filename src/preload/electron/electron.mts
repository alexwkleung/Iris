//taken from: https://github.com/alex8088/electron-toolkit/blob/master/packages/preload/src/index.ts

import { ipcRenderer, webFrame, contextBridge } from 'electron'
import { ElectronAPI } from './electron.mjs'

export type { ElectronAPI, IpcRenderer, IpcRendererListener, WebFrame, NodeProcess } from './types.js'
